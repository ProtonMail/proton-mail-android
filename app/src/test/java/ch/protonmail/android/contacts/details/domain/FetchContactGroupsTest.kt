...
class FetchContactGroupsTest : ArchTest, CoroutinesTest {
    ...
    fun verifyStandardCaseJustOneEmissionOfTwoValues() = runBlockingTest {
        ...
        val contactLabel1 = ContactLabelEntity(labelId1, "name1", "color1", 1, 0, false, 2)
        val contactLabel2 = ContactLabelEntity(labelId2, "name2", "color2", 1, 0, false, 2)
    ...
    fun verifyStandardCaseTwoEmissionsOfThreeValuesInTotal() = runBlockingTest {
        ...
        val contactLabel1 = ContactLabelEntity(labelId1, "name1", "color1", 1, 0, false, 0)
        val contactLabel2 = ContactLabelEntity(labelId2, "name2", "color2", 1, 0, false, 1)
        val contactLabel3 = ContactLabelEntity(labelId3, "name3", "color3", 1, 0, false, 2)
