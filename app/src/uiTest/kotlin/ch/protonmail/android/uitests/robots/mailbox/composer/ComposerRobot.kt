...
//            view.withText(R.string.message_sent).inRoot(rootView.withNotCurrentActivityDecorView())
    ...
    fun waitForCondition(
        ...
        val timeoutTimestamp = currentTimestamp + ProtonTest.commandTimeout
...
//            } catch (e: Throwable) {
//                val firstLine = e.message?.split("\n")?.get(0)
//                Log.v(ProtonTest.testTag, "Waiting for condition. ${watchTimeout - timeInterval}ms remaining. Status: $firstLine")
//                throwable = e
//            }
