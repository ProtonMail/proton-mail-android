...
public class Login2FAEvent extends ResponseBody {
    ...
    public Login2FAEvent(
            final @NonNull AuthStatus status,
            final @Nullable LoginInfoResponse infoResponse,
            final @NonNull Id userId,
            final @NonNull Name username,
            final byte[] password,
            final @Nullable LoginResponse loginResponse,
