...
public class LoginInfoEvent extends ResponseBody {
    ...
    public LoginInfoEvent(final @NonNull AuthStatus status, final @Nullable LoginInfoResponse response, final String username, final byte[] password, final int fallbackAuthVersion) {
        this.status = status;
