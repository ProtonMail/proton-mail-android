...
abstract class NotificationsDatabaseFactory : RoomDatabase() {
    abstract fun getDatabase(): NotificationsDatabase

    companion object {
        private const val DEFAULT_DATABASE_FILENAME = "NotificationsDatabase.db"
        private val DATABASES = mutableMapOf<String, NotificationsDatabaseFactory>()

        @JvmOverloads
        @Synchronized
        fun getInstance(context: Context, username: String? = null): NotificationsDatabaseFactory {
        ...
        private fun buildDatabase(context: Context, username: String): NotificationsDatabaseFactory {
            ...
            return Room.databaseBuilder(context.applicationContext,
                    NotificationsDatabaseFactory::class.java,
