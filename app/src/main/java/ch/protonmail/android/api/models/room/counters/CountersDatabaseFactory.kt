...
@Database(entities = [UnreadLabelCounter::class, UnreadLocationCounter::class, TotalLabelCounter::class, TotalLocationCounter::class], version = 1)
abstract class CountersDatabaseFactory : RoomDatabase() {
    ...
    companion object {
        ...
        private val DATABASES = mutableMapOf<String, CountersDatabaseFactory>()
        ...
        private fun buildDatabase(context: Context, username: String): CountersDatabaseFactory {
            ...
            return Room.databaseBuilder(context.applicationContext,
                    CountersDatabaseFactory::class.java,
