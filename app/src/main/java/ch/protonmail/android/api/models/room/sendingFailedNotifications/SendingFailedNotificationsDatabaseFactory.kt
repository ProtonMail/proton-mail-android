...
abstract class SendingFailedNotificationsDatabaseFactory : RoomDatabase() {
    abstract fun getDatabase(): SendingFailedNotificationsDatabase

    companion object {
        private const val DEFAULT_DATABASE_FILENAME = "SendingFailedNotificationsDatabase.db"
        private val DATABASES = mutableMapOf<String, SendingFailedNotificationsDatabaseFactory>()

        @JvmOverloads
        @Synchronized
        fun getInstance(context: Context, username: String? = null): SendingFailedNotificationsDatabaseFactory {
        ...
        private fun buildDatabase(context: Context, username: String): SendingFailedNotificationsDatabaseFactory {
            ...
            return Room.databaseBuilder(context.applicationContext,
                    SendingFailedNotificationsDatabaseFactory::class.java,
