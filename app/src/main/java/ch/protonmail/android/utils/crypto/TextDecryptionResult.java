...
public class TextDecryptionResult extends AbstractDecryptionResult {
    ...
    public TextDecryptionResult(String decrypted, boolean hasSignature, boolean signatureIsValid) {
        super(hasSignature, signatureIsValid);
        this.decrypted = decrypted;
    }

    public TextDecryptionResult(String decrypted, long verificationResult) {
