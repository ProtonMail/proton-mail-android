...
class NewUserOnboardingViewModel @Inject constructor(
    ...
    ).stateIn(viewModelScope, SharingStarted.Lazily, State(emptyList()))
    ...
    data class State(val onboardingItemsList: List<OnboardingItemUiModel>)
}
