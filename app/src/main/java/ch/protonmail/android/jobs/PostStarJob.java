...
public class PostStarJob extends ProtonMailEndlessJob {
    ...
    public void onAdded() {
        for (String id : mMessageIds) {
            messageDetailsRepository.updateStarred(id, true);
        }
    }
    ...
    public void onRun() throws Throwable {
        ...
        mApi.labelMessages(new IDList(String.valueOf(Constants.MessageLocationType.STARRED.getMessageLocationTypeValue()), messageIds));
    }
}
