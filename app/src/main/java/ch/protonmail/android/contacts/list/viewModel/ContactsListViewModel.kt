 ...
 *
 * This should be refactored to make usage of repository pattern. Do not access the database directly from here.*/
...
) : ViewModel(), IContactsListViewModel, ISearchListenerViewModel, IToastViewModel by toastViewModel {
