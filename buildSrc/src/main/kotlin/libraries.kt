...
val DependencyHandler.`Proton-network-dagger` get() =               proton("network-dagger") version `Proton-core version`
...
val DependencyHandler.`Proton-report-dagger` get() =                proton("report-dagger") version `Proton-core version`
